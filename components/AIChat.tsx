...
const AIChat: React.FC<AIChatProps> = ({ isOpen, onToggle }) => {
  ...
  // Keyboard shortcut 'R' to reset chat when open
  useEffect(() => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
      {/* Chat Window */}
      {isOpen && (
        <div className="mb-4 flex w-[90vw] flex-col overflow-hidden rounded-2xl border border-gray-200 dark:border-white/10 bg-surface/95 shadow-2xl backdrop-blur-xl sm:w-[380px] h-[500px] transition-colors duration-300 animate-in slide-in-from-bottom-5 fade-in">
          {/* Header */}
      ...
      <button
        ...
        title="Chat with AI (Ctrl+Shift+S)"
      >
