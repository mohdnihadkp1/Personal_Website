    ...
    <div className="glass-panel col-span-1 md:col-span-2 row-span-1 rounded-3xl p-6 md:p-8 relative overflow-hidden transition-colors duration-300 h-full flex flex-col justify-center">
      ...
      <div className="relative z-10 flex flex-col h-full mt-4 md:mt-0">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-1">
              <input
                ...
                className={`w-full rounded-xl bg-gray-50/50 dark:bg-black/20 border px-4 py-3 text-sm text-gray-900 dark:text-white placeholder-gray-500 focus:outline-none focus:ring-1 transition-all ${error ? 'border-red-500 focus:border-red-500 focus:ring-red-500' : 'border-gray-200 dark:border-white/10 focus:border-primary focus:ring-primary'}`}
              />
            </div>
          </div>
          <div className="space-y-1">
          ...
          {error && (
              <div className="flex items-center gap-2 text-red-500 dark:text-red-400 text-xs mt-1">
                  <AlertCircle size={12} />
                  {error}
              </div>
          )}
